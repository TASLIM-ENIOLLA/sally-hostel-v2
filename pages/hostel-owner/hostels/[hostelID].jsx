...
export default function Index({account_type, jwt_token}){
    ...
    useEffect(() => {
        fetch(API.hostel_owner.get_hostel_data, {method: 'POST', body: ParseObjectToFormData({jwt_token, hostel_id: hostelID})})
        .then(e => e.json())
                            ...
                            <div className = 'col-lg-8'>
                                <div className = 'row'>
                                    ...
                                    <div className = 'col-12 d-none'>
                                        <div className = 'row'>
                                            <div className = 'col-6'>
                                                <a  href = {`../make-payment/${id}`} className = 'text-center p-4 rounded-2x shadow text-dark bg-warning text-white underline-0 border-0 d-block w-100 text-capitalize half-bold'>edit hostel</a>
                                            </div>
                                            <div className = 'col-6'>
                                                <a  href = {`../make-payment/${id}`} className = 'text-center p-4 rounded-2x shadow bg-danger text-white underline-0 border-0 d-block w-100 text-capitalize half-bold'>delete hostel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
