...
export default {
    ...
    form_validation: (national_ID, drivers_licence, passport, proof_of_ownership) => {
        if([national_ID, drivers_licence, passport, proof_of_ownership].includes(null)) return {
            type: 'danger',
